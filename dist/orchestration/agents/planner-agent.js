...
export class PlannerAgent {
     ...
     */
    async createPlan(environment, workloadProfile, policy, templatesDir) {
        ...
        const strategy = await this.determineSearchStrategy(environment, workloadProfile, policy, policyFilteredTemplates);
     ...
     */
    async determineSearchStrategy(environment, workloadProfile, policy, templates) {
     ...
     */
    prioritizeTemplates(templates, workloadProfile) {
     ...
     */
    estimateDuration(templates, strategy) {
