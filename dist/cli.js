...
program
    ...
    try {
        ...
        const profile = await orchestrator.profilerAgent.profileWorkload(options.events, {});
        ...
        profile.clustered_intents.forEach((intent, i) => {
...
program
    ...
    try {
        ...
        const plan = await orchestrator.plannerAgent.createPlan(environment, {}, // workload profile
        policy, options.templatesDir);
...
program
    ...
    try {
        ...
        const results = await orchestrator.runnerAgent.executeWithEarlyStopping({}, // plan
        {}, // environment
        {}, // workload profile
        false // dry run
        );
...
program
    ...
    try {
        ...
        const audit = await orchestrator.auditorAgent.auditResults([], // execution results
        {}, // environment
        {}, // workload profile
        {} // policy
        );
