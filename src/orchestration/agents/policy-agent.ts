...
export class PolicyAgent {
   ...
   */
  async loadPolicy(policyPath?: string): Promise<OptimizationPolicy> {
   ...
   */
  private async loadPolicyFromFile(filePath: string): Promise<OptimizationPolicy | null> {
    try {
   ...
   * Get default policy
   */
  private getDefaultPolicy(): OptimizationPolicy {
    return {
   ...
   * Log policy details
   */
  private logPolicy(policy: OptimizationPolicy): void {
